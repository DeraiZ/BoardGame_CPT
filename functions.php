...
function save_game_info_meta_box_data( $post_id ) {
    ...
    if ( isset( $_POST['game_name'])){
        update_post_meta($post_id,'_game_name',strval($_POST['game_name']) );
    }

    if ( isset( $_POST['game_year'])){
        update_post_meta($post_id,'_game_year',strval($_POST['game_year']) );
    }

    if ( isset( $_POST['game_price'])){
        update_post_meta($post_id,'_game_price',strval($_POST['game_price']) );
    }

    if ( isset( $_POST['game_date'])){
        update_post_meta($post_id,'_game_date',strval($_POST['game_date']) );
    }

    if ( isset( $_POST['game_time'])){
        update_post_meta($post_id,'_game_time',strval($_POST['game_time']) );
    }

    if ( isset( $_POST['game_nb_player'])){
        update_post_meta($post_id,'_game_nb_player',strval($_POST['game_nb_player']) );
    }

    if ( isset( $_POST['game_content'])){
        update_post_meta($post_id,'_game_content',strval($_POST['game_content']) );
    }
